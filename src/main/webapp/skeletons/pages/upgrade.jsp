...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
	...
	<form class="form-horizontal" action="upgrade" method="post">
	 ...
	 <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      <h1 class="display-4">Developer? Join here!<br></h1>
      ...
      <div class="card-deck mb-3 text-center">
        <div class="card mb-4 box-shadow">
          <div class="card-header">
            <h4 class="my-0 font-weight-normal" style="text-decoration-line: none;">Free <small class="text-muted">(during Beta)</small><i></i><br></h4>
          </div>
          <div class="card-body">
