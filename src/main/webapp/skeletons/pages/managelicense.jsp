...
<form class="form-horizontal" action="manage" method="post">
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="number" id="duration" name="duration" class="form-control input-md" value="${license.getDuration()}">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input type="number" id="type" name="type" class="form-control input-md" value="${license.getType()}">
			</div>
		</div>
