		...
		<nav class="col-md-2 d-none d-md-block bg-light sidebar">
			<div class="sidebar-sticky">
				...
				<ul class="nav flex-column">
					...
					<c:if test="${user != null }">
						<li class="nav-item"><a class="nav-link" href="/destroy">
								<span data-feather="user-x"></span> Logout
						</a></li>
					</c:if>

					<c:if test="${user != null }">
						<li class="nav-item"><a class="nav-link"
							href="/user/licenses"> <span data-feather="activity"></span>
								My Licenses
						</a></li>
					</c:if>
					...
					<c:if test="${user != null }">
						<li class="nav-item"><a class="nav-link"
							href="/user/licenses/activate"> <span data-feather="key"></span>
								Activate License
						</a></li>
					</c:if>
