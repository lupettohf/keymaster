...
public class LicenseDAO {
	...
	{
		String QUERY = "INSERT INTO license (appid, name, description, duration, type) VALUES (?,?,?,?,?)";
	...
	{
		String QUERY = "SELECT * FROM license WHERE appid = ?";
	...
	{
		String QUERY = "UPDATE license SET (name, description, duration, type) VALUES (?,?,?,?) WHERE id = ?";
